<div <?php if($autoPrompt): ?> wire:init="authenticateWithPasskey" <?php endif; ?>>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Filament\Facades\Filament::getCurrentOrDefaultPanel()?->hasPlugin('filament-breezy')): ?>
        <div>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message = session()->get('authenticatePasskey::message')): ?>
...
<?php /**PATH C:\laragon\www\pariwisatalive\vendor\jeffgreco13\filament-breezy\resources\views\livewire\passkey-action.blade.php ENDPATH**/ ?>