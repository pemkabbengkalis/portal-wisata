...
<div <?php echo $deferLoading ? ' wire:init="loadWidget" ' : ''; ?> class="flex items-center justify-center filament-apex-charts-chart"
    ...
    <?php else: ?>
        <div class="filament-apex-charts-chart-loading-indicator m-auto">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loadingIndicator): ?>
...
<?php /**PATH C:\laragon\www\pariwisatalive\vendor\leandrocfe\filament-apex-charts\resources\views\widgets\components\chart.blade.php ENDPATH**/ ?>