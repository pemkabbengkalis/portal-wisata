 ...
 <!-- Tourism Menu Section -->
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex flex-nowrap md:flex-wrap justify-start md:justify-center overflow-x-auto gap-4 md:gap-8 pb-4 scrollbar-hide mb-8">
            ...
            <button
                ...
                <div
                    ...
                    <i class="<?php echo e($destCat->icon_class); ?> text-2xl"></i>
                </div>
                <span
        ...
        <div
            ...
            <div data-grid class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" id="grid-<?php echo e($destCat->slug); ?>">
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col md:flex-row gap-6 group">
                    <div class="w-full md:w-1/3 shrink-0 overflow-hidden rounded-lg shadow-sm">
                        <img src="<?php echo e($news->thumbnail ? asset('storage/'.$news->thumbnail) : 'https://placehold.co/400x300?text=News'); ?>" class="w-full h-48 object-cover group-hover:scale-105 transition duration-500">
                    </div>
                    <div class="flex-1">
                        <span class="text-red-700 text-xs font-bold uppercase"><?php echo e($news->category->name); ?></span>
