...
<head>
    ...
    <title><?php echo e($setting->maintenance_title ?? 'Website Under Maintenance'); ?></title>
    ...
    <div class="relative z-10 max-w-2xl w-full">
        <div class="text-center mb-6">
            ...
            <h1 class="text-s md:text-s font-extrabold text-white mb-3 drop-shadow-lg">
                <?php echo e($setting->maintenance_title ?? 'Website Under Maintenance'); ?>
        ...
        <div class="glass-effect rounded-3xl p-6 md:p-8 shadow-2xl mb-6">
            <div class="text-center mb-6">
                <p class="text-lg md:text-xl text-white/90 leading-relaxed">
                    <?php echo e($setting->maintenance_message ?? 'We are currently performing scheduled maintenance to improve your experience. We\'ll be back shortly!'); ?>
            ...
            <div class="text-center border-t border-white/20 pt-6">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($setting->email)): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($setting->phone)): ?>
        ...
        <div class="text-center">
            <p class="text-white/70 mb-4">
                ...
                Started:
                <?php echo e($setting->maintenance_started_at ? $setting->maintenance_started_at->format('d F Y, H:i') : now()->format('d F Y, H:i')); ?>

                WIB
            </p>
            <p class="text-white/60 text-sm">
                © <?php echo e(now()->year); ?> <?php echo e($setting->site_name ?? config('app.name')); ?>. All rights reserved.
            </p>
...
</html><?php /**PATH C:\laragon\www\pariwisatalive\resources\views\maintenance.blade.php ENDPATH**/ ?>