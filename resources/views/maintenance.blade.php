...
<body class="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 min-h-screen flex items-center justify-center p-4 overflow-hidden relative">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-1/2 left-1/3 w-64 h-64 bg-pink-400/20 rounded-full blur-3xl animate-float" style="animation-delay: 2s;"></div>
    ...
    <div class="relative z-10 max-w-4xl w-full">
        <div class="text-center mb-8">
            ...
            <div class="relative inline-block mb-6">
                ...
                <div class="relative w-32 h-32 mx-auto bg-white rounded-full shadow-2xl flex items-center justify-center">
            ...
            <div class="inline-block glass-effect px-6 py-3 rounded-full mb-8">
                <div class="flex items-center gap-3 text-white">
                    <div class="flex gap-1">
                        ...
                        <span class="w-3 h-3 bg-yellow-400 rounded-full animate-pulse" style="animation-delay: 0.2s;"></span>
        ...
        <div class="glass-effect rounded-3xl p-8 md:p-12 shadow-2xl mb-8">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                <div class="text-center">
                    ...
                    <h3 class="text-white font-bold text-lg mb-2">Server Upgrade</h3>
                    <p class="text-white/70 text-sm">Optimizing performance</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-white font-bold text-lg mb-2">Security Update</h3>
                    <p class="text-white/70 text-sm">Enhancing protection</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-white font-bold text-lg mb-2">New Features</h3>
            ...
            <div class="mb-8">
                ...
                <div class="h-3 bg-white/20 rounded-full overflow-hidden">
                    <div id="progress-bar" class="h-full bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 rounded-full transition-all duration-1000 ease-out" style="width: 0%"></div>
                </div>
            </div>
            ...
            <div class="text-center border-t border-white/20 pt-6">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="mailto:{{ $setting->email }}" class="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 px-6 py-3 rounded-xl text-white font-medium transition-all duration-300 transform hover:scale-105">
                    ...
                    <a href="tel:{{ $setting->phone }}" class="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 px-6 py-3 rounded-xl text-white font-medium transition-all duration-300 transform hover:scale-105">
        ...
        <div class="text-center">
            <p class="text-white/70 mb-4">
                ...
                Started: {{ $setting->maintenance_started_at ? $setting->maintenance_started_at->format('d F Y, H:i') : now()->format('d F Y, H:i') }} WIB
            </p>
            ...
            <div class="flex justify-center gap-4 mt-4">
                <a href="#" class="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110">
